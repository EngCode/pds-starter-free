...
<div class="study-card col-auto pdy-15 tx-align-center" itemtype="https://schema.org/LocalBusiness" itemscope>
    <div class="position-rv content-box bg-white radius-lg border-1 border-solid border-alpha-10 h-min-100 radius-md bx-shadow-dp-1y">
        ...
        <!-- Content -->
        <div class="pdx-20 pdy-20">
            <!-- Title -->
            <a itemprop="url" href="<?php echo $post_link; ?>" class="color-dark">
                <h3 class="fs-15 mb-15" itemprop="name"><?php echo $post_title; ?></h3>
            </a>
            <!-- Info -->
            <div class="flexbox divider-t pdt-10 pdb-5 pdx-5 gpy-10 align-between align-center-y fs-13">
                <span class="fas fa-chart-pie tx-icon color-primary">
                    <strong class="color-dark"><?php echo __("معدل العائد: ", "phenix"). $revenue; ?></strong>
                </span>
                <span class="fas fa-envelope-open-dollar tx-icon color-secondary">
                    <strong class="color-dark"><?php echo __("رأس المال: ", "phenix"). $capital; ?></strong>
                </span>
            </div>
            <!-- Button -->
            <button data-modal="study-order"class="btn secondary small radius-height fluid fs-14 weight-medium"><?php echo __("أطلب الان", "phenix"); ?></button>
        </div>
    </div>
</div>
<!-- // Block End -->